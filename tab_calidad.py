...
class TabCalidad(ttk.Frame):
    ...
    def _get_nodule_contours(self, image_bgr, blur_size=5, threshold=0, min_area=None, use_open=True):
        ...
        for cnt in contours:
            ...
            classification = self._classify_particle_material(mean_val, solidity, mean_bgr, circ)
            result.append({
    ...
    def _count_nodules_opencv(self, image_bgr, px_per_mm=None, threshold=0, min_area=None, use_open=True):
        ...
        for cnt in contours:
            ...
            mat = self._classify_particle_material(mean_val, solidity, mean_bgr_p, circularity)
