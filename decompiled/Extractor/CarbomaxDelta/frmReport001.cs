...
public class frmReport001 : Form
{
	public DataSet dsData = new DataSet("dsData");
	...
	private void frmReportPreview_Load(object sender, EventArgs e)
	{
		try
		{
			...
			pdf = Path.GetTempPath() + "CarboxMaxDelta_" + registro + ".pdf";
			rptViewer.LocalReport.DataSources.Clear();
			ReportDataSource item = new ReportDataSource("dsAnaliseValue", dsData.Tables[0]);
			rptViewer.LocalReport.DataSources.Add(item);
			item = new ReportDataSource("dsAnaliseData", dsData.Tables[1]);
			rptViewer.LocalReport.DataSources.Add(item);
			item = new ReportDataSource("dsAnaliseName", dsData.Tables[2]);
			rptViewer.LocalReport.DataSources.Add(item);
	...
	private void InitializeComponent()
	{
		...
		this.rptViewer.LocalReport.ReportEmbeddedResource = "CarbomaxDelta.Reports.rdlc.ReportCarb.rdlc";
		this.rptViewer.LocalReport.ReportPath = "Reports/rdlc/ReportCarb.rdlc";
